...
PTR_LCD_CURSOR     EQU PTR_INTR_WORD + 2
PTR_PRINTF_RET     EQU PTR_INTR_WORD + 3
PTR_PREV_SCAN_CODE EQU PTR_INTR_WORD + 4
PTR_TEXT_BUFF_BGN  EQU PTR_INTR_WORD + 5
PTR_TEXT_BUFF_END  EQU PTR_INTR_WORD + 6
PTR_TEMP_WORD      EQU PTR_INTR_WORD + 7  ;; 2 bytes ;; TODO: Make this word separate for each file Command / FileSystem
PTR_INPUT_STATE    EQU PTR_INTR_WORD + 9  ;; char '>' | '|'
PTR_INPUT_FUNC     EQU PTR_INTR_WORD + 10 ;; 2 bytes
PTR_INPUT_FILE     EQU PTR_INTR_WORD + 12 ;; 2 bytes
