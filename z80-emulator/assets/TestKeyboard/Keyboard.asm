...
.SCAN_CODE_ASCII_VEC_ST:
  ...
  db 0x49, 0x4A, 0x29, 0x0D, 0x52, 0x5A
.SCAN_CODE_ASCII_VEC_ED:

.LOWERCASE_VEC_ST:
  db "`1234567890-=qwertyuiop[]\asdfghjkl;zxcvbnm,./ ", HORIZ_TAB, SINGLE_QUOTE, LINE_FEED

.UPPERCASE_VEC_ST:
  db "~!@#$%^&*()_+QWERTYUIOP{}|ASDFGHJKL:ZXCVBNM<>? ", HORIZ_TAB, DOUBLE_QUOTE, LINE_FEED
